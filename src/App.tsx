...
const App = () => (
  <div className="flex items-center justify-center min-h-screen bg-slate-200">
    <div className="flex-1 align-middle text-grey-darker text-center px-4 py-2 m-2">
      ...
      <h1 className="text-6xl font-normal leading-tight mt-0 mb-2 text-indigo-900">
        Starter Kit
      </h1>
      <h2 className="text-3xl leading-normal mt-8 mb-2 text-gray-400">
        TailwindCSS added to `.html`. Have fun.
      </h2>
    </div>
  </div>
)
